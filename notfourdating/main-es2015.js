...
const routes = [
    ...
    {
        path: 'navigation',
        loadChildren: () => __webpack_require__.e(/*! import() | navigation-navigation-module */ "navigation-navigation-module").then(__webpack_require__.bind(null, /*! ./navigation/navigation.module */ "./src/app/navigation/navigation.module.ts")).then(m => m.NavigationPageModule)
    },
    {
        path: 'location-targetting',
        loadChildren: () => Promise.all(/*! import() | location-targetting-location-targetting-module */[__webpack_require__.e("default~location-targetting-location-targetting-module~register-register-module~tabs-tabs-module"), __webpack_require__.e("location-targetting-location-targetting-module")]).then(__webpack_require__.bind(null, /*! ./location-targetting/location-targetting.module */ "./src/app/location-targetting/location-targetting.module.ts")).then(m => m.LocationTargettingPageModule)
    },
    {
        path: 'register',
        loadChildren: () => Promise.all(/*! import() | register-register-module */[__webpack_require__.e("default~location-targetting-location-targetting-module~register-register-module~tabs-tabs-module"), __webpack_require__.e("register-register-module")]).then(__webpack_require__.bind(null, /*! ./register/register.module */ "./src/app/register/register.module.ts")).then(m => m.RegisterPageModule)
    },
    {
        path: 'chat',
    ...
    {
        path: 'tabs',
        loadChildren: () => Promise.all(/*! import() | tabs-tabs-module */[__webpack_require__.e("default~location-targetting-location-targetting-module~register-register-module~tabs-tabs-module"), __webpack_require__.e("tabs-tabs-module")]).then(__webpack_require__.bind(null, /*! ./tabs/tabs.module */ "./src/app/tabs/tabs.module.ts")).then(m => m.TabsPageModule)
    },
    {
        path: 'tabs2',

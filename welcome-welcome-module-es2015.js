...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./no-result-found/no-result-found.module */ "./src/app/welcome/no-result-found/no-result-found.module.ts")).then(m => m.NoResultFoundPageModule)
    },
    {
        path: 'not-logged-popup',
        loadChildren: () => __webpack_require__.e(/*! import() | not-logged-popup-not-logged-popup-module */ "not-logged-popup-not-logged-popup-module").then(__webpack_require__.bind(null, /*! ./not-logged-popup/not-logged-popup.module */ "./src/app/welcome/not-logged-popup/not-logged-popup.module.ts")).then(m => m.NotLoggedPopupPageModule)
    },
];
...
/* harmony import */ var _Signin_find_friends_find_friends_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Signin/find-friends/find-friends.module */ "./src/app/Signin/find-friends/find-friends.module.ts");
/* harmony import */ var _Signin_tophobbies_tophobbies_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Signin/tophobbies/tophobbies.module */ "./src/app/Signin/tophobbies/tophobbies.module.ts");
/* harmony import */ var _no_result_found_no_result_found_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./no-result-found/no-result-found.module */ "./src/app/welcome/no-result-found/no-result-found.module.ts");
...
WelcomePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _Signin_find_friends_find_friends_module__WEBPACK_IMPORTED_MODULE_9__["FindFriendsPageModule"],
            _Signin_tophobbies_tophobbies_module__WEBPACK_IMPORTED_MODULE_10__["TophobbiesPageModule"],
            _no_result_found_no_result_found_module__WEBPACK_IMPORTED_MODULE_11__["NoResultFoundPageModule"],
        ],
...
let WelcomePage = class WelcomePage {
    constructor(ConfigService, geolocation, platform, nativeGeocoder, zone, _Activatedroute, routes, locate, http, splashScreen, Diagnostic, emailComposer) {
        ...
        this.ConfigService.getPostal(this.postcode, this.pageIndex).subscribe((elements) => {
            ...
            if (this.currPage.length > 0) {
                ...
                if (this.currPage.length < 10) {
                    this.ConfigService.getPostal(this.postcode.substring(0, 4), this.pageIndex).subscribe((elements) => {
                        this.currPage = Object.keys(elements).map((i) => elements[i]);
                        this.searchResponse = this.searchResponse.concat(this.currPage);
                    });
                }

...
const routes = [
    ...
    {
        path: "signin",
        loadChildren: () => Promise.all(/*! import() | signin-signin-module */[__webpack_require__.e("default~Navigation-blockedusers-blockedusers-module~chat-ChatsThreadListing-ChatsThreadListing-modul~74a3f2ad"), __webpack_require__.e("signin-signin-module")]).then(__webpack_require__.bind(null, /*! ./signin/signin.module */ "./src/app/signin/signin.module.ts")).then((m) => m.SigninPageModule),
    },
    {
    ...
    {
        path: "popup/:uid",
        loadChildren: () => Promise.all(/*! import() | chat-userDetail-userDetail-module */[__webpack_require__.e("default~Navigation-blockedusers-blockedusers-module~chat-ChatsThreadListing-ChatsThreadListing-modul~74a3f2ad"), __webpack_require__.e("chat-userDetail-userDetail-module")]).then(__webpack_require__.bind(null, /*! ./chat/userDetail/userDetail.module */ "./src/app/chat/userDetail/userDetail.module.ts")).then((m) => m.userDetailPageModule),
    },
    {
        path: 'new-message/:uid/:name',
        loadChildren: () => Promise.all(/*! import() | chat-searchUser-new-message-new-message-module */[__webpack_require__.e("default~Navigation-blockedusers-blockedusers-module~chat-ChatsThreadListing-ChatsThreadListing-modul~74a3f2ad"), __webpack_require__.e("chat-searchUser-new-message-new-message-module")]).then(__webpack_require__.bind(null, /*! ./chat/searchUser/new-message/new-message.module */ "./src/app/chat/searchUser/new-message/new-message.module.ts")).then(m => m.NewMessagePageModule)
    },
    {
        path: 'find-friends',
        loadChildren: () => Promise.all(/*! import() | signin-find-friends-find-friends-module */[__webpack_require__.e("default~Navigation-blockedusers-blockedusers-module~chat-ChatsThreadListing-ChatsThreadListing-modul~74a3f2ad"), __webpack_require__.e("signin-find-friends-find-friends-module")]).then(__webpack_require__.bind(null, /*! ./signin/find-friends/find-friends.module */ "./src/app/signin/find-friends/find-friends.module.ts")).then(m => m.FindFriendsPageModule)
    },
    {
        path: 'edit-profile',

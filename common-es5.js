...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppWelcomeNoResultFoundNoResultFoundPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppWelcomeNoResultFoundNoResultFoundRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NoResultFoundPageRoutingModule", function () {
      return NoResultFoundPageRoutingModule;
    });
    /* harmony import */
    ...
    var _no_result_found_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var NoResultFoundPageRoutingModule = function NoResultFoundPageRoutingModule() {
      _classCallCheck(this, NoResultFoundPageRoutingModule);
    };

    NoResultFoundPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
      exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
  ...
  /***/
  function srcAppWelcomeNoResultFoundNoResultFoundModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NoResultFoundPageModule", function () {
      return NoResultFoundPageModule;
    });
    /* harmony import */
    ...
    var _no_result_found_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./no-result-found-routing.module */
    "./src/app/welcome/no-result-found/no-result-found-routing.module.ts");
    /* harmony import */


    var _no_result_found_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./no-result-found.page */
    "./src/app/welcome/no-result-found/no-result-found.page.ts");

    var NoResultFoundPageModule = function NoResultFoundPageModule() {
      _classCallCheck(this, NoResultFoundPageModule);
    };

    NoResultFoundPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _no_result_found_routing_module__WEBPACK_IMPORTED_MODULE_5__["NoResultFoundPageRoutingModule"]],
  ...
  /***/
  function srcAppWelcomeNoResultFoundNoResultFoundPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppWelcomeNoResultFoundNoResultFoundPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NoResultFoundPage", function () {
    ...
    var NoResultFoundPage = /*#__PURE__*/function () {
      function NoResultFoundPage(emailComposer) {
        _classCallCheck(this, NoResultFoundPage);

        this.emailComposer = emailComposer;
      }

      _createClass(NoResultFoundPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "email",
        value: function email() {
          this.emailComposer.getClients().then(function (apps) {// Returns an array of configured email clients for the device
          });
          this.emailComposer.hasClient().then(app, function (isValid) {
            if (isValid) {// Now we know we have a valid email client configured
              // Not specifying an app will return true if at least one email client is configured
            }
          });
          this.emailComposer.hasAccount().then(function (isValid) {
            if (isValid) {// Now we know we have a valid email account configured
            }
          });
          this.emailComposer.isAvailable().then(app, function (available) {
            if (available) {// Now we know we can send an email, calls hasClient and hasAccount
              // Not specifying an app will return true if at least one email client is configured
            }
          });
          var email = {
    ...
    NoResultFoundPage.ctorParameters = function () {
      return [{
        type: _ionic_native_email_composer_ngx__WEBPACK_IMPORTED_MODULE_2__["EmailComposer"]
      }];
    };

    NoResultFoundPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-no-result-found',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./no-result-found.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/welcome/no-result-found/no-result-found.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./no-result-found.page.scss */
      "./src/app/welcome/no-result-found/no-result-found.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_email_composer_ngx__WEBPACK_IMPORTED_MODULE_2__["EmailComposer"]])], NoResultFoundPage);
    /***/
  }
}]);

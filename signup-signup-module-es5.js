...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
  ...
  function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(http, zone, alertController, sanitizer, filed, fileChooser, base64, device, camera, FilePath, changeDetector) {
        ...
        this.selectedFile = null; //file:any
      ...
      _createClass(SignupPage, [{
        ...
        value: function onUpload(picture) {
          ...
          this.http.post("https://gowebtutorial.com/api/json/file/", this.uploadData).subscribe(function (rest) {
            _this.Picurl = rest;
            console.log(_this.Picurl); // Image URL

            _this.displayImage = "https://gowebtutorial.com/sites/default/files/" + _this.uploadData.filename;
            console.log(_this.displayImage); // Show next button

            _this.imageContinue = true;
        ...
        key: "submitForm",
        value: function submitForm(name, fname, lname, DOB, Gender, contract, meet, live, zip, activity, email, confirmemail, password, confirmpassword) {
        ...
        key: "getImageObject",
        value: function getImageObject(name, fname, lname, DOB, Gender, contract, meet, live, zip, activity, email, confirmemail, password, confirmpassword) {
          var _this2 = this;

          this.isLoading = true;
          this.http.get("https://gowebtutorial.com/api/json/file/" + this.Picurl.fid).subscribe(function (res) {
            _this2.picturesUrl = res;
            console.log(_this2.picturesUrl);

            _this2.submitDetails(name, fname, lname, DOB, Gender, contract, meet, live, zip, activity, email, confirmemail, password, confirmpassword);
          });
        }
      }, {
        key: "submitDetails",
        value: function submitDetails(name, fname, lname, DOB, Gender, contract, meet, live, zip, activity, email, confirmemail, password, confirmpassword) {
          var _this3 = this;
          ...
          this.http.post("https://gowebtutorial.com/api/json/user/register", submitObject).subscribe(function (data) {
            _this3.post = data;
            console.log(data);
        ...
        value: function openCamera() {
          ...
          this.camera.getPicture(options).then(function (imageData) {
            ...
            _this4.base64.encodeFile(imageData).then(function (base64File) {
              //Filename
              var timestamp = Math.floor(Date.now() / 1000);
              _this4.fileName = _this4.name + "_profile_image_" + timestamp + ".jpg"; //Base 64 String

              var removeString = "data:image/*;charset=utf-8;base64,";
              _this4.base64textString = base64File.replace(removeString, "");
              _this4.picture = _this4.fileName;

              _this4.onUpload(_this4.picture);
            }, function (err) {
              console.log(err);
            });
        ...
        value: function filechooser() {
          ...
          this.fileChooser.open().then(function (fileuri) {
            ...
            var imagePath = _this5.win.Ionic.WebView.convertFileSrc(fileuri);

            _this5.displayImage = imagePath;

            _this5.FilePath.resolveNativePath(fileuri).then(function (filePath) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"], _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_5__["File"], _ionic_native_file_chooser_ngx__WEBPACK_IMPORTED_MODULE_6__["FileChooser"], _ionic_native_base64_ngx__WEBPACK_IMPORTED_MODULE_7__["Base64"], _ionic_native_device_ngx__WEBPACK_IMPORTED_MODULE_8__["Device"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_9__["Camera"], _ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_10__["FilePath"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]])], SignupPage);
    /***/
  }
}]);
